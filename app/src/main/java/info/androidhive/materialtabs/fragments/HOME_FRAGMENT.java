...
import info.androidhive.materialtabs.adapter.Home_screen_grid_view;
...
//        Home_screen_grid_view adapter = new Home_screen_grid_view(getActivity(),
//                List_Subscription
//        );
...
//                getActivity().startActivity(i1);
                ...
                Intent i1 = new Intent(getActivity(), info.androidhive.materialtabs.activity.Product_list.class);
                i1.putExtra("id", id_);
    ...
    private class Product_list extends AsyncTask<Void, String, Void> implements DialogInterface.OnCancelListener {
