package info.androidhive.materialtabs.paypal;
 ...
 */
public class paypal_activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent1 = new Intent(paypal_activity.this, PaymentActivity.class);
    ...
    private PayPalPayment getThingToBuy(String paymentIntent) {
        return new PayPalPayment(new BigDecimal("10"), "USD", "sample item",
                paymentIntent);
    }
    ...
    public void onFuturePaymentPressed(View pressed) {
        Intent intent = new Intent(paypal_activity.this, PayPalFuturePaymentActivity.class);
    ...
    public void onProfileSharingPressed(View pressed) {
        Intent intent = new Intent(paypal_activity.this, PayPalProfileSharingActivity.class);
    ...
    protected void displayResultText(String result) {
       // ((TextView)findViewById(R.id.txtResult)).setText("Result : " + result);
        Toast.makeText(
                ...
                .show();
        Intent i1 = new Intent(paypal_activity.this, CustomViewIconTextTabsActivity.class);
